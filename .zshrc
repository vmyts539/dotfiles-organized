...
plugins=(git macos dirhistory sudo history emoji colorize web-search copyfile copybuffer copypath tmux)
...
alias git-author-stats="git log --author=\"Vasyl Mytskaniuk\" --pretty=tformat: --numstat | gawk '{ add += $1; subs += $2; loc += $1 - $2 } END { printf \"added lines: %s removed lines: %s total lines: %s\n\", add, subs, loc }' -"
